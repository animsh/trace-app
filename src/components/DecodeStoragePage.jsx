...
import DecodeStorageItem from "./DecodeStorageItem";

function DecodeStoragePage(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://127.0.0.1:8000/api/users/decodedfiles", {
        headers: {
    ...
    <React.Fragment>
      <div className="container">
        ...
        {storageFiles.map((file) => (
          <DecodeStorageItem key={file.id} file={file} />
        ))}
...
export default DecodeStoragePage;
